...
class TestRecentImages(unittest.TestCase):
    ...
    def testAddImage(self, mockTK):
        ...
        mockTK.Frame.assert_any_call(mockScrollFrame, width=recent_images.THUMBNAIL_WIDTH,
                                     height=recent_images.THUMBNAIL_HEIGHT)
        mockTK.Canvas.assert_any_call(mockImageCell, width=recent_images.THUMBNAIL_WIDTH,
                                      height=recent_images.THUMBNAIL_HEIGHT)
        mockImageCellCanvas.pack.assert_any_call()
        mockImageFile.makeImage.assert_any_call('thumbnail', (recent_images.THUMBNAIL_WIDTH,
